  ...
  return (
      ...
      <Container className='bg-tailtertiary m-3'>
        <div className='flex-col mx-4'>
          ...
          <div className="flex">
            <p className='px-3 mx-auto py-1 border-2 border-blue-500 bg-tailtertiary3 rounded-md'>Inventory Manager</p>
          </div>
        </div>
...
export default ViewSingleManager;
